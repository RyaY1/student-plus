package com.student.media.service.impl;
...
import com.student.media.mapper.MediaFilesMapper;
...
import com.student.media.service.MediaFileService;
import io.minio.*;
...
public class MediaFileServiceImpl implements MediaFileService {
    ...
    public UploadFileResultDto uploadFile(Long companyId, UploadFileParamsDto uploadFileParamsDto, String localFilePath) {
        ...
        if (!file.exists()) {
            StudentPlusException.cast("文件不存在");
        }
        //文件名称
    ...
    public MediaFiles addMediaFilesToDb(Long companyId,String fileMd5,UploadFileParamsDto uploadFileParamsDto,String bucket,String objectName){
        ...
        if (mediaFiles == null) {
            ...
            if (insert < 0) {
                ...
                StudentPlusException.cast("保存文件信息失败");
            }
    ...
    public boolean addMediaFilesToMinIO(String localFilePath,String mimeType,String bucket, String objectName) {
        try {
            ...
            StudentPlusException.cast("上传文件到文件系统失败");
        }
        return false;
    }
    ...
    public RestResponse<Boolean> checkFile(String fileMd5) {
        ...
        if(mediaFiles!=null){
            ...
            try {
                ...
                if (stream != null) {
                    //文件已存在
                    return RestResponse.validfail(false,"文件已经存在！");
                }
            } catch (Exception e) {
    ...
    public RestResponse<Boolean> checkChunk(String fileMd5, int chunkIndex) {
        ...
        try {
            ...
            if (fileInputStream != null) {
                //分块已存在
                return RestResponse.validfail(false,"分片已经存在！");
            }
        } catch (Exception e) {
        }
        //分块未存在
    ...
    public RestResponse uploadChunk(String fileMd5, int chunk,String localFilePath) {
        ...
        try {
            ...
            //将文件存储至minIO
            boolean b = addMediaFilesToMinIO(localFilePath, mimeType, bucket_videofiles, chunkFilePath);
            if(b){
    ...
    public RestResponse mergechunks(Long companyId, String fileMd5, int chunkTotal, UploadFileParamsDto uploadFileParamsDto) {
        ...
        List<ComposeSource> sourceObjectList = Stream.iterate(0, i -> ++i).limit(chunkTotal).map(i -> ComposeSource.builder()
                        .bucket(bucket_videofiles).object(chunkFileFolderPath.concat(Integer.toString(i))).build())
                .collect(Collectors.toList());
        //=====合并=====
        //文件名称
        String fileName = uploadFileParamsDto.getFilename();
